...
- PyMuPDF is used to extract text from text-based PDFs.
- Tesseract OCR is used to process scanned PDFs and images.
...
https://github.com/Teja6189/document-summary-assistant
